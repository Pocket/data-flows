...
SNOWFLAKE_FIVETRAN_DATABASE = os.getenv('SNOWFLAKE_FIVETRAN_SCHEMA', 'FIVETRAN')
SNOWFLAKE_FIVETRAN_BRAZE_SCHEMA = os.getenv('SNOWFLAKE_FIVETRAN_BRAZE_SCHEMA', 'BRAZE')
