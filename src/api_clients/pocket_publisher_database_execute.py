...
class PocketPublisherDatabaseExecute(MySQLExecute):
    """
    PocketPublisherDatabaseExecute automatically connects to our Publisher MySQL Database if the right environment variables are set:
    ...
    def run(
        ...
        self.logger.info(f'Rows Updated: {query_result}')
