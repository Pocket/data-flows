...
from common.databases.sqlalchemy_utils import MozSqlalchemyCredentialsRead
...
QUERY_ENGINE_MAPPING = {
    ...
    "postgres": {"sqlalchemy_credentials": MozSqlalchemyCredentialsRead},
    "mysql": {"sqlalchemy_credentials": MozSqlalchemyCredentialsRead},
}
