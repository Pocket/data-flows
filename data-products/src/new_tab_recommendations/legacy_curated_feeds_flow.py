...
from shared.api_clients.sqs import NewTabFeedID, validate_candidate_items
...
async def main():
    ...
    print(valid_scheduled_candidate_items)
    ...
    # scheduled_candidate_items = query.map(
    #     data=set_params, query=unmapped(EXPORT_SCHEDULED_ITEMS_SQL)
    # )
